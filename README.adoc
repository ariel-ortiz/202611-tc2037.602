= Tc2037.602 Implementation of Computational Methods

_Tecnológico de Monterrey, Estado de México._

This project contains all the source files that the course instructor will be writing in class during the 2026 February-June semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/202611-tc2037.602.git tc2037
    
 3. Change your current working directory to `tc2037`:
